function [ avg_cmd_vel, avg_vel_abs, avg_min_dis_in_range, avg_avg_dis_in_range,robotPos, total_duration] = processOneFile_sim( filename )
...
range_near = 3;
[avg_vel_abs,avg_min_dis_in_range,avg_avg_dis_in_range,avg_cmd_vel] = avgPeopleNearestDist_real(periods,robotPos,robotVel,controlVel,min_person_dist,range_near);
% avg_vel_abs
